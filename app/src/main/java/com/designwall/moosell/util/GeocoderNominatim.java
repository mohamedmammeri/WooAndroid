...
public class GeocoderNominatim {
	...
	private static final String userAgent = "OsmNavigator/2.2";
...
//		return result;
	 ...
	 * @return the whole content, or null if any issue.
	 */
	private String requestStringFromUrl(String url) {
		String result = "";
		try {
			result = requestStringFromUrl(url, null);
		} catch (IOException e) {
			e.printStackTrace();
		}
		return result;

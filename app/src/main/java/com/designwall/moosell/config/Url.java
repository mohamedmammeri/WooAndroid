...
public class Url {
    ...
    public static final String OBJ_NAME_ORDER_NOTE = "order_note";
    ...
    public static String getProductsInCategory(String categoryName){
        return getProducts() + "?filter[category]="+categoryName;
    }

    public static String getProductsInCategoryCount(String categoryName){
        return getProducts() + "/" + API_COUNT + "?filter[category]="+categoryName;
    }
